...
### Necessary Packages:
    ...
    sudo pacman -S inxi linux-headers man-db tldr git base-devel yay fast scrcpy yt-dlp fzf ytfzf \
                   ...
                   pavucontrol mpv mpv-mpris python-requests kvantum kvantum-qt5 \
                   gvfs gvfs-mtp mtpfs pacman-contrib thefuck cava \
...
#### Other:
    ...
    yay -S kdenlive krita antimicrox bitwarden goverlay qdirstat celluloid epiphany \
           ...
           hardinfo pamac-aur ksysguard gnome-dictionary waydroid zed --needed
...
#### i3
    ...
    yay -S i3 polybar rofi picom dunst scrot xsel xcolor xwallpaper clipmenu redshift lxappearance polkit-gnome tesseract-data-tur tesseract-data-rus tesseract-data-deu --needed
