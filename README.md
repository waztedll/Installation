...
### Base Packages
    ...
    sudo pacman -S inxi linux-headers man-db tldr git base-devel yay scrcpy yt-dlp fzf ytfzf gdm \
                   ...
                   network-manager-applet ffmpegthumbnailer tumbler tgpt acpi tree lact intel-gpu-tools \
...
<details id="gnome">
    ...
    yay -S gnome-shell gnome-control-center gnome-tweaks gnome-browser-connector gnome-menus \
           gnome-bluetooth-3.0 power-profiles-daemon dconf-editor polkit-gnome extension-manager \
           --needed; yay -Rdd nautilus
